...
#define COMPONENT_DESCRIPTION_CECHOATTENUATOR "pseudo echo cancellation by attenuating input based on output envelope"
#define COMPONENT_NAME_CECHOATTENUATOR "cEchoAttenuator"

class cEchoAttenuator : public cDataProcessor {
  private:
