...
SMILECOMPONENT_REGCOMP(cFunctionalCrossings)
{
  ...
  SMILECOMPONENT_IFNOTREGAGAIN(
    ct->setField("zcr","1/0=enable/disable computation of zero crossing rate",1);
    ct->setField("mcr","1/0=enable/disable computation of mean crossing rate (zcr of 0-mean values)",1);
