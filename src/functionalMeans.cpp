...
SMILECOMPONENT_REGCOMP(cFunctionalMeans)
{
  ...
  SMILECOMPONENT_IFNOTREGAGAIN(
    ct->setField("amean","1/0=enable/disable computation of arithmetic mean",1);
    ct->setField("absmean","1/0=enable/disable computation of absolute value arithmetic mean",1);
    ct->setField("qmean","1/0=enable/disable computation of quadratic mean",1);
    ct->setField("nzamean","1/0=enable/disable computation of arth. mean (non-zero values only)",1);
    ct->setField("nzabsmean","1/0=enable/disable computation of abs. val. arth. mean (non-zero values only)",1);
    ct->setField("nzqmean","1/0=enable/disable computation of quadratic mean (non-zero values only)",1);
    ct->setField("nzgmean","1/0=enable/disable computation of geometric mean (of abs. vals. of non-zero values only)",1);
    ct->setField("nnz","1/0=enable/disable computation of number of non-zero values",1);
  )
