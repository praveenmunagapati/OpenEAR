...
#define COMPONENT_DESCRIPTION_CVECGLMEAN "compute gliding mean of input vectors and subtract it from the vectors (use for Cepstral Mean Subtraction, for example)"
...
class cVecGlMean : public cVectorProcessor {
  private:
    const char * initFile;
