...
SMILECOMPONENT_REGCOMP(cFunctionalPeaks)
{
  ...
  SMILECOMPONENT_IFNOTREGAGAIN(
    ct->setField("numPeaks","1/0=enable/disable computation of number of peaks",1);
    ct->setField("meanPeakDist","1/0=enable/disable computation of mean distance between peaks",1);
    ct->setField("peakMean","1/0=enable/disable computation of arithmetic mean of peaks",1);
    ct->setField("peakMeanMeanDist","1/0=enable/disable computation of aritmetic mean of peaks - aritmetic mean",1);
    ct->setField("overlapFlag","1/0=yes/no frames overlap (i.e. compute peaks locally only)",1);
  )
