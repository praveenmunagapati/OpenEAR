...
this file also contains openSMILE's small and dirty platform independence layer and thread implementations
...
#define APPCPYEAR   "2008-2009"
#define APPDATE    "01-09-2009"
...
//#define smileThreadJoinWret(THRD,RET) pthread_join(THRD,&RET)
#define smileThreadJoinWret(THRD,RET) WaitForSingleObject(THRD, 10000)
//#define smileThreadJoin(THRD) pthread_join(THRD,NULL)
#define smileThreadJoin(THRD) WaitForSingleObject(THRD, 10000)
