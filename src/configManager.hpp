...
class ConfigType {
  ...
  public:
    ...
    int setField(const char *_name, const char *description, int type, int subtype, const ConfigType *subType, int freeType=1, int _N=0);

    int setField(const char *_name, const char *description, int dflt, int arr=0);
    int setField(const char *_name, const char *description, double dflt, int arr=0);
    int setField(const char *_name, const char *description, const char * dflt, int arr=0);
    int setField(const char *_name, const char *description, char dflt, int arr=0);
    ...
    void printTypeHelp(char *basestr=NULL, int _subtype=1) const;  // print description of fields in this type (and all sub-types, if subtype=1)
...
class cConfigManager {
  ...
  public:
    ...
    void printTypeHelp(int _subtype=1, const char *selection=NULL);
