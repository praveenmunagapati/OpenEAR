...
#define COMPONENT_DESCRIPTION_CDATASELECTOR "dataSelector, selects data by element/field name"
...
class cDataSelector : public cDataProcessor {
  private:
    ...
    int nElSel;  // actual number of elements(!) selected (size of mapping array)
